...
//		Map<KeyCode, Boolean> pressedKeys = new HashMap<>(); // keys are mapped to values, 
		...
		new AnimationTimer() {
			...
			public void handle(long nanotime) {
				...
				if (pressedKeys.getOrDefault(KeyCode.SPACE, false) && level.getCanShoot() && System.nanoTime()-shootTimer >= 2e8 && bullets.size() < 5) {
