...
public class Menu {
	...
	public void start(Stage menuStage) throws Exception {
		...
		startButton.setStyle(
				"-fx-background-color: transparent; -fx-text-fill: white; -fx-border-color: white; -fx-border-width: 2px;");
		exitButton.setStyle(
				"-fx-background-color: transparent; -fx-text-fill: white; -fx-border-color: white; -fx-border-width: 2px;");
		...
		highScoreButton
				.setOnMouseEntered(e -> highScoreButton.setStyle("-fx-background-color: black; -fx-text-fill: white;"));
		...
		// This method will create a new pane for the game menu where the game will be
		// played.
		// when the button is clicked we will create an instance of our gameWindow class
		...
		highScoreButton.setOnAction(e -> {
		    try {
		        ...
		        VBox highScoresMenu = new VBox(10);
		        highScoresMenu.setPrefSize(800, 600);

		        Button returnButton = new Button("Return to Menu");
		        returnButton.setPrefSize(120, 40);
		        returnButton.setStyle(
						"-fx-background-color: transparent; -fx-text-fill: black; -fx-border-color: black; -fx-border-width: 2px;");
		        
		        returnButton.setOnMouseExited(event -> returnButton.setStyle(
						"-fx-background-color: transparent; -fx-text-fill: black; -fx-border-color: black; -fx-border-width: 2px;"));
		        ...
		        highScoresMenu.getChildren().add(returnButton);
		        Scene highScoresScene = new Scene(highScoresMenu);
		        highScoreStage.setTitle("High Scores");
		        highScoreStage.setScene(highScoresScene);
